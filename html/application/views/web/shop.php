			...
			?>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					<div class="hot-single hot-category">
						<a href="<?php echo base_url()?>web/category/latest_1/0/<?php echo $tmp->cid;?>"><img src="<?php echo base_url()?>site/categories/<?php echo $tmp->image;?>" alt="" style="height:200px;width:100%">
						</a>
						
						<div class="wid-rating">
							<h4>
								<a href="<?php echo base_url()?>web/category/latest_1/0/<?php echo $tmp->cid;?>">
									<?php $name = "category_name_".lang(); echo $tmp->$name;?>
								</a>
							</h4>
						</div>
						...
						<div class="wid-rating">
							...
							<div style="clear:both;"></div>
						 	<div class="product-wid-price" style="display:table;margin-top:-20px;">
								...
								<a class="cursor add-cart-btn add-cart-btn-shop" style="margin:0px;" id="shop_<?php echo $tmp->pid;?>"><?php echo get_lang('Add_Cart');?></a>
							</div>
						</div>
					</div>
                        </div>
...
$(document).ready(function(){
		...
		$(document).on("click",".new_first",function(){				
		     window.location.href = "<?php echo base_url()?>web/shop/latest_1";			 
		});
		
		$(document).on("click",".old_first",function(){	
		     window.location.href = "<?php echo base_url()?>web/shop/latest_0";			 
		});
		
		$(document).on("click",".low_first",function(){	
		     window.location.href = "<?php echo base_url()?>web/shop/0/price_0";			 
		});
		$(document).on("click",".high_first",function(){	
		     window.location.href = "<?php echo base_url()?>web/shop/0/price_1";			 
		});
