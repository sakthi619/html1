...
<![endif]-->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width:650px;" >
          ...
          <td style="background:#FFF; padding:15px 10px; border:#ddd solid 1px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="background:#fff; padding:20px 15px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="font-size:14px; line-height:22px; color:#333; font-family:tahoma, arial; padding:8px 0;"> To verify your new email, please click the below link </td>
                    </tr>
                    <tr>
                      <td style="font-size:14px; line-height:22px; color:#333; font-family:tahoma, arial; padding:8px 0;"><a href="<?php echo base_url()?>emailVerify/<?php echo $verification;?>"><?php echo base_url()?>emailVerify/<?php echo $verification;?></a> <br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="font-size:14px; color:#333; font-family:tahoma, arial">EGROZERY</td>
                    </tr>
                    <tr>
                      <td style="font-size:0px; line-height:0px" height="20">&nbsp;</td>
                    </tr>
                    <tr>
                      <td style="font-size:14px; line-height:0px; color:#333; font-family:tahoma, arial; padding:8px 0;"> We would love to hear from you on <a href="">contact@egrozery.com</a> <br></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="center" style="font-size:14px; color:#333; font-family:tahoma, arial; text-align:center; padding:0 0 20px 0; ">Buy all the grocery items at one place</td>
              </tr>
              <tr>
                <td style="font-size:0px; line-height:0px;" height="10">&nbsp;</td>
              </tr>
        ...
        <tr>
        <td style="background:#8e061e; text-align:center; font-size:12px; line-height:18px; color:#fff; font-family:tahoma, arial; padding:13px" align="center">&copy;(2017) egrozery.com All rights reserved.</td>
        </tr>
      </table>
