          ...
          <td style="background:#FFF; padding:15px 10px; border:#ddd solid 1px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="background:#fff; padding:20px 15px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="font-size:14px; line-height:22px; color:#333; font-family:tahoma, arial; padding:8px 0;"> We are delighted to have you with us. </td>
                    </tr>
                    <tr>
                      <td style="font-size:14px; line-height:22px; color:#333; font-family:tahoma, arial; padding:8px 0;"> Hundreds of flower items are available here, you can choose your favorites! <br></td>
                    </tr>
                    <tr>
